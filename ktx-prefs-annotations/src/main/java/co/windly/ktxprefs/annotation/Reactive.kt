 ...
 * <p>
 * For example, you can enable / disable generation of extension
 * methods.
 * <p>
...
annotation class Reactive(
  ...
  /**
   * Changes if update of given preference should be emitted always
   * or only if they were unique.
   *
   * @return information when updates of given preference should be
   * emitted.
   */
